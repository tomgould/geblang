...
type Evaluator struct {
	...
	httpResponseStreamMu  sync.Mutex
	nextResponseStreamID  int64
	httpResponseStreams   map[int64]*httpResponseStreamHandle
	httpStreamRespClass   *runtime.Class
	jsonMu                sync.Mutex
	nextJSONID            int64
