...
var stdlibCatalog = map[string]moduleDoc{
	...
	"collections": {functions: map[string]functionDoc{
		...
		"sorted":          fn([]string{"list<any> values", "func compare = null"}, "list<any>", "Returns values sorted by an optional comparator (-1 / 0 / 1)."),
		"sortBy":          fn([]string{"list<any> values", "func keySelector"}, "list<any>", "Returns values sorted by the selector's return."),
	...
	"http": {functions: map[string]functionDoc{
		"serve":              fn([]string{"string addr", "func handler", "dict<string, any> opts = {}"}, "void", "Starts an HTTP server. opts may set maxConcurrent / queueSize / onOverload."),
		"listen":             fn([]string{"string addr", "func handler", "dict<string, any> opts = {}"}, "Server", "Starts an HTTP server handle. opts may set maxConcurrent / queueSize / onOverload."),
	...
	"encoding": {functions: map[string]functionDoc{
		...
		"base64UrlDecode": fn([]string{"string text"}, "bytes", "URL-safe Base64 decode; accepts padded or unpadded input."),
