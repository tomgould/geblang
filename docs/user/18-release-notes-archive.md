...
Release notes for versions prior to 1.20.0, kept for history. These
are not part of the published documentation site. For current
releases see the [release notes](18-release-notes.md).
